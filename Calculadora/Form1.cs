...
public partial class Form1 : Form
{
    ...
    private void InicializarComponentes()
    {
        ...
        btnSin.Click+= new EventHandler(btnSen_Click);
        ...
        btnXy.Click+= new EventHandler(btnPotencia_Click);
    ...
    private void btnSen_Click(object? sender, EventArgs e){
        lblOperacion.Text=$"Sen({txtDisplay.Text})=";
        txtDisplay.Text=Math.Sin(Double.Parse(txtDisplay.Text)).ToString();
    }

    private void btnBin_Click(object? sender, EventArgs e){
        string entrada = txtDisplay.Text;
        Boolean valido = true;
        foreach(char elemento in entrada){
            if(elemento=='.'){
                valido=false;
            }
        }
        if(valido){
            ...
            txtDisplay.Text="Error matematico";
        }
    }
    ...
    private void btnSinH_Click(object? sender, EventArgs e){
        ...
        string resultado = Math.Asin(Double.Parse(txtDisplay.Text)).ToString();
        if(resultado=="NaN"){
            txtDisplay.Text="Error matematico";
        }else{
    ...
    private void btnDec_Click(object? sender, EventArgs e){
        ...
        if(binario){
            ...
            int exp=0;
            int resul=0;
            int valor = Int32.Parse(txtDisplay.Text);
            do{
                res=valor%10;
                valor=valor/10;
                resul+=(int)(res*Math.Pow(2, exp));
                exp=exp+1;
            }while (valor!=0);
            txtDisplay.Text=resul.ToString();
        }else{
            txtDisplay.Text="Error matematico";
        }
    }
    ...
    private void btnCosH_Click(object? sender, EventArgs e){
        ...
        string resultado = Math.Acos(Double.Parse(txtDisplay.Text)).ToString();
        if(resultado=="NaN"){
            txtDisplay.Text="Error matematico";
        }else{
            txtDisplay.Text=resultado;
    ...
    private void btn1X_Click(object? sender, EventArgs e){
        ...
        string resultado = (1/(Double.Parse(txtDisplay.Text))).ToString();
        if(resultado=="NaN"){
            txtDisplay.Text="Error matematico";
        }else{
            txtDisplay.Text=resultado;
    ...
    private void btnTanH_Click(object? sender, EventArgs e){
        ...
        string resultado = Math.Atan(Double.Parse(txtDisplay.Text)).ToString();
        if(resultado=="NaN"){
            txtDisplay.Text="Error matematico";
        }else{
            txtDisplay.Text=resultado;
